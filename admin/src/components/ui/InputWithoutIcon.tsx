  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative mt-3">
            <input ref={ref} {...props} type={type === "password" ? (showPassword ? "text" : "password") : type} className={`h-11 w-full px-4 text-sm border border-line focus:border-main ${props.className}`} />
